...
//    }
    ...
    public static String generate(String host, int port, RestAPI type, String cmd) {
        URI uri = null;
     ...
     *
     * Note: we do not really need to parse the arguments by our own,
     * so this method is actually deprecated.
     */
...
//        return sb.toString();
    ...
    public static void main(String[] args) {
        ...
        String test = "use dataverse company;" +
                      "for $l in dataset('Tasks') return $l;";
        String test2 = "use dataverse Tasks;" +
                       "insert into dataset TaskThree({ \"node_id\": 10, \"suggested_friends\": [ 4, 6, 5 ] });";
